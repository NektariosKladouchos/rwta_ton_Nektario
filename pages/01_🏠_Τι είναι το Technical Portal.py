...
# ---------------------------------------------------------
# ADMIN ANALYTICS (ONLY IF ADMIN MODE IS ACTIVE)
# ---------------------------------------------------------
if is_admin:
    st.subheader("📊 Analytics (Μόνο για Admin)")
    st.write("Εδώ θα μπουν τα analytics της σελίδας Εισαγωγή.")
    st.info("Το admin mode είναι ενεργό — το analytics λειτουργεί κανονικά.")
