...
with tab_calc:
    ...
    with right:
        ...
        # Έλεγχος Ποσοτήτων για κοινά είδη
        is_common_hvac = (h_type == "Split" and c_type == "Split") or \
        ...
        if not error_msg and is_common_hvac and h_qty != c_qty:
            error_msg = f"❌ ΛΑΘΟΣ: Ο ΑΡΙΘΜΟΣ ΜΟΝΑΔΩΝ {h_type} ΠΡΕΠΕΙ ΝΑ ΕΙΝΑΙ ΙΔΙΟΣ ΣΕ Θ/Ψ"
        ...
        if error_msg:
            ...
            if total_dev > 230: st.error(f"❌ ΟΡΙΟ 230 ΣΥΣΚΕΥΩΝ (Εχετε {total_dev})")
            else:
