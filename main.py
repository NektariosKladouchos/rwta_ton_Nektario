...
# --- CUSTOM CSS ΓΙΑ COMPACT UI & STICKY DISPLAY ---
st.markdown("""
    <style>
    .stApp { background-color: #f8f9fa; }
    /* Μικρότερες γραμματοσειρές αριστερά */
    .stNumberInput label, .stSelectbox label, .stRadio label {
        font-size: 13px !important;
        font-weight: bold !important;
        margin-bottom: -10px !important;
    }
    .stNumberInput div div input { font-size: 14px !important; padding: 5px !important; }
    /* Sticky Right Column */
    ...
    .display-box {
        ...
        border-radius: 5px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);
    }
    pre {
...
with tab_calc:
    ...
    with left:
        ...
        h_type = st.selectbox("Τύπος", h_list, key="ht")
        ...
        c_type = st.selectbox("Τύπος ", c_list, key="ct")
