...
with tab_calc:
    ...
    with right:
        ...
        if error:
            ...
            h_r = []; h_q = 0; h_t = 0
            if base <= 37: h_t = PRICES["hub_small"]; h_q = 1; h_r.append(f"{'Κεντρική μονάδα (40 συσκευές)':<40} | 1       | {h_t:9.2f}€")
            elif base <= 97: h_t = PRICES["hub_large"]; h_q = 1; h_r.append(f"{'Κεντρική μονάδα (100 συσκευές)':<40} | 1       | {h_t:9.2f}€")
        ...
        st.code(final_offer, language="text")
