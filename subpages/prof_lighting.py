...
def show():
    ...
    # ---------------------------------------------------------
    #  ΕΝΟΤΗΤΑ 1 – Προβλήματα που λύνουμε (ΝΕΑ ΕΙΚΟΝΑ + ΕΥΘΥΓΡΑΜΜΙΣΗ)
    # ---------------------------------------------------------
    ...
    with colA:
        st.markdown("""
        - Πολλοί διακόπτες στον τοίχο για πολλές γραμμές φωτισμού.
    ...
    with colB:
        st.image(
            ...
            caption="Πολλοί διακόπτες για πολλές γραμμές φωτισμού → σύγχυση & κακή εργονομία",
    ...
    # ---------------------------------------------------------
    #  ΕΝΟΤΗΤΑ 2 – Οι Λύσεις μας (ΜΕ ΔΙΚΕΣ ΣΟΥ ΦΩΤΟΓΡΑΦΙΕΣ + ΕΥΘΥΓΡΑΜΜΙΣΗ)
    # ---------------------------------------------------------
