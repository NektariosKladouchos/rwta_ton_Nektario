...
def show():
    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel1:
        ...
        app_images = [
            {"title": "Κεντρική Οθόνη (Favourites)", "url": "subpages/pictures/FAVOYRITES_1.png", "desc": "Κεντρική οθόνη που ο κάθε χρήστης φτιάχνει την οθόνη που θέλει ορίζοντας να βλέπει τις αγαπημένες του συσκευές."},
            {"title": "Κεντρική Οθόνη (Favourites)", "url": "subpages/pictures/FAVOURITES_2.png", "desc": "Στο πάνω μέρος εμφανίζονται συγκεντρωτικά και ανά κατηγορίες οι συσκευές.Στο κάτω μέρος αναλύτικά οι συσκευές ανα κατηγορία."},
            {"title": "Συσκευές ανά κατηγορία", "url": "subpages/pictures/FAVOURITES_3.png", "desc": "Ο χρήστης επιλέγει ποιά κατηγόρία θα ποιά συσκευή θα  εμφανίζετε.Εδώ φαίνονται οι καταστάσεις των κλιματιστικών και των ALARMS"},
            {"title": "Ανάλυση συσκευών ανά κατηγορία", "url": "subpages/pictures/FAVOURITES_4.png", "desc": "Επιλέγοντας κατηγορία απο το πάνω μενού ,εμφανίζει αναλυτικά τις συγκεκριμένες συσκευές και την κατάστασή τους."},
            {"title": "Μετεωρολογικός Σταθμος", "url": "subpages/pictures/FAVOURITES_5.png", "desc": "Εμφανίζει την κατάσταση καιρού(Ηλιοφάνεια,βροχή την εξωτερική θερμοκρασία ,υγρασία,ταχύτητα ανέμου."},
            {"title": "Οθόνη παρουσίασης Δωματίων ", "url": "subpages/pictures/ΗΟΜΕ_1.png", "desc": "Μας δείχνει τα δωμάτια που έχουμε δημιουργήσει και συμαντικές πληροφορίες όπως θερμοκρασία και υγρασία δωματίου κ.α."},  
            {"title": "Ανάλυση συσκευών Δωματίου", "url": "subpages/pictures/HOME_2.png", "desc": "Επιλέγοντας κάποιο δωμάτιο βλέπουμε και διαχειριζόμαστε τις συσκευές του."},     
            {"title": "Δωμάτιο Ηλεκτρικός Πίνακας", "url": "subpages/pictures/HOME_3.png", "desc": "Παρακολουθούμε την παρουσία με βάση την κάρτα ,την θερμοκρασία νερού Boiler,και την κατάσταση του θερμοσίφωνα."},
            {"title": "Ενότητα Scenes ", "url": "subpages/pictures/SCENES_1.png", "desc": "Παρουσιάζονται τα σενάρια που έχουμε φτιάξει π.χ για παρουσία και ζεστά νερά χρήσης "},
            {"title": "Σενάρια κλιματιστικών ", "url": "subpages/pictures/SCENES_2.png", "desc": "Δημιουργία σεναρίων για κλείδωμα θερμοκρασίων σε κάθε θερμοστάτη κλιματιστικού .Ανώτερο και κατώτερο όριο ."},
            {"title": "Επιλογή Σεναρίων ", "url": "subpages/pictures/SCENES_5.png", "desc": "Απομακρυσμένη επιλογή για τον αν θα είναι ενεργό ή οχι το κάθε σενάριο. "},
            {"title": "Συγκεντρωτική οθόνη θερμοστατών ", "url": "subpages/pictures/MORE_1.png", "desc": "Για απομακρυσμένη λειτουργία του κάθε κλιματιστικού ή live παρακολούθηση της κατάστασης τους."}, 
            {"title": "Οθόνη ALARM", "url": "subpages/pictures/MORE_2.png", "desc": "Παρακολούθηση λειτουργίας και απομακρυσμένης διαχείρισης της κάθε ζώνης συναγερμού που έχουμε ορίσει για κάθε Δωμάτιο."},
