...
def show():
    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel2:
        ...
        pc_images = [
            {"title": "Κεντρικός Έλεγχος των δωματίων του Διαμερισμάτος","filename": "05_SCENES.png", "desc": "Πλήρες ταμπλό ελέγχου όπου ο ιδιοκτήτης επιβλέπει και τα 3 ακίνητα ταυτόχρονα στην ίδια οθόνη."},
