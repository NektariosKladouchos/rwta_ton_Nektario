    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel2:
        ...
        pc_images = [
            ...
            {"title": "Δημιουργία Σεναρίου Παρουσίας ", "url": "subpages/pictures/11_SETTINGS_SCENES_2.png", "desc": "Δημιουργία σεναρίου σε μορφή (BLOCK SCENE ).Ορίζει τι θα γίνει με το που μπεί η κάρτα "},
            {"title": "Δημιουργία Σεναρίου Θερμοσίφωνα", "url": "subpages/pictures/11_SETTINGS_SCENES_3.png", "desc": "Δημιουργία σεναρίου για άνοιγμα θερμοσίφωνα για μια ώρα με συνθήκη την θερμοκρασία νερού και την παρουσία στον χώρο ."},
