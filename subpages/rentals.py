...
def show():
    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel2:
        ...
        pc_images = [
            {"title": "Ρυθμίσεις Συσκευών", "url": "subpages/pictures/09_SETTINGS_DEVICES.png", "desc": "Πλήρες ταμπλό ελέγχου όπου ο ιδιοκτήτης επιβλέπει, παραμετροποιεί και διαχειρίζεται τις συνδεδεμένες συσκευές."},
            {"title": "Διαχείριση & Οργάνωση Δωματίων", "url": "subpages/pictures/10_SETTINGS_ROOMS.png", "desc": "Διαχωρισμός και έλεγχος των ανώτατων και κατώτατων ορίων των συσκευών ανά δωμάτιο του ακινήτου."},
