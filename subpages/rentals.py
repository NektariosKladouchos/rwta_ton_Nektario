    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel2:
        ...
        pc_images = [
            ...
            {"title": "Ιστορικό παρακολούθησης λειτουργίας Συσκευών", "url": "subpages/pictures/03_history_Thermostat_IR.png", "desc": "Ιστορικό για τοπική λειτουργία απο τον πελάτη του καταλύματος.Καταγραφή όλων των κινήσεων  "},
            {"title": "Ιστορικό λειτουργίας Σεναρίων ", "url": "subpages/pictures/04_history_scene open windows close AC.png", "desc": "Ιστορικό για παρακολούθηση σεναρίων με ημερομηνία και ώρα "},
            {"title": "Κέντρο Ρύθμισης Σκηνών", "url": "subpages/pictures/11_SETTINGS_SCENES_1.png", "desc": "Πάνελ παραμετροποίησης βασικών αυτοματισμών και κρίσιμων ειδοποιήσεων για τη λειτουργία του κτιρίου."},
            {"title": "Κέντρο Ρύθμισης Σκηνών", "url": "subpages/pictures/11_SETTINGS_SCENES_1.png", "desc": "Πάνελ παραμετροποίησης βασικών αυτοματισμών και κρίσιμων ειδοποιήσεων για τη λειτουργία του κτιρίου."},
            {"title": "Κέντρο Ρύθμισης Σκηνών", "url": "subpages/pictures/11_SETTINGS_SCENES_1.png", "desc": "Πάνελ παραμετροποίησης βασικών αυτοματισμών και κρίσιμων ειδοποιήσεων για τη λειτουργία του κτιρίου."},
            {"title": "Κέντρο Ρύθμισης Σκηνών", "url": "subpages/pictures/11_SETTINGS_SCENES_1.png", "desc": "Πάνελ παραμετροποίησης βασικών αυτοματισμών και κρίσιμων ειδοποιήσεων για τη λειτουργία του κτιρίου."},
            {"title": "Κέντρο Ρύθμισης Σκηνών", "url": "subpages/pictures/11_SETTINGS_SCENES_1.png", "desc": "Πάνελ παραμετροποίησης βασικών αυτοματισμών και κρίσιμων ειδοποιήσεων για τη λειτουργία του κτιρίου."},
