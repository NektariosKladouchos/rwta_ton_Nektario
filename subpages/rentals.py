...
with col_carousel1:
    ...
    app_images = [
        ...
        {"title": "Συσκευές ανά κατηγορία", "url": "subpages/pictures/FAVOURITES_3.jpg", "desc": "Ο χρήστης επιλέγει ποιά κατηγορία θα ποιά συσκευή θα εμφανίζεται.Εδώ φαίνονται οι καταστάσεις των κλιματιστικών και των ALARMS"},
