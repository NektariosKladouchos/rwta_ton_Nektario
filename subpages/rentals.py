    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel1:
        ...
        app_images = [
            ...
            {"title": "Κεντρική Οθόνη (Favourites)", "url": "subpages/pictures/FAVOURITES_2.jpg", "desc": "Στο πάνω μέρος εμφανίζονται συγκεντρωτικά και ανά κατηγορίες οι συσκευές.Στο κάτω μέρος αναλύτικά οι συσκευές ανα κατηγορία."},
            {"title": "Συσκευές ανά κατηγορία", "url": "subpages/pictures/FAVOURITES_3.jpg", "desc": "Ο χρήστης επιλέγει ποιά κατηγόρία θα ποιά συσκευή θα  εμφανίζετε.Εδώ φαίνονται οι καταστάσεις των κλιματιστικών και των ALARMS"},
            ...
            {"title": "Οθόνη παρουσίασης Δωματίων ", "url": "subpages/pictures/ΗΟΜΕ_1.jpg", "desc": "Μας δείχνει τα δωμάτια που έχουμε δημιουργήσει και συμαντικές πληροφορίες όπως θερμοκρασία και υγρασία δωματίου κ.α."},  
