...
def show():
    ...
    * **Ασφάλεια & Πρόληψη:** Ενσωμάτωση έξυπνων ανιχνευτών καπνού, μονοξειδίου και διοξειδίου του άνθρακα, καθώς και αισθητήρων πλημμύρας για την άμεση προστασία του κτιρίου από ατυχήματα.
    ...
    with col_carousel2:
        ...
        pc_images = [
            {"title": "Κεντρικός Έλεγχος 3 Διαμερισμάτων", "url": "https://unsplash.com", "desc": "Πλήρες ταμπλό ελέγχου όπου ο ιδιοκτήτης επιβλέπει και τα 3 ακίνητα ταυτόχρονα στην ίδια οθόνη."},
